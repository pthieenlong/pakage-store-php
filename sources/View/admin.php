...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="localhost/pakage-store/sources/View/">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <button class="collapse-item" id="product-btn">Products</butt>
                        <button class="collapse-item" id="user-btn">User</button>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <form
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="admin.php">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Tìm kiếm..."
                                aria-label="Search" aria-describedby="basic-addon2">
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit" name="admin-search">
                ...
                <div class="container-fluid">
                    <section class="product-controller" id="product-controller">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Product Editor</h1>
                            <a class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#add-product"><i
                                ...
                                for($i = 0; $i < count($products); $i++) {
                                    ...
                                    echo "
                                            ...
                                            <div class='card-header py-3 d-flex flex-row align-items-center justify-content-between'>
                                                <h6 class='m-0 font-weight-bold text-primary'>{$products[$i]->getName()}
                                                </h6>
                                                <div class='dropdown no-arrow'>
                                                    ...
                                                    <div class='dropdown-menu dropdown-menu-right shadow animated--fade-in'
                                                        ...
                                                        <div class='dropdown-header'>Controller:</div>
                                                        <button class='dropdown-item' onclick='enableEditor(this);'>Edit</button>
                                                        <div class='dropdown-divider'></div>
                    ...
                    <section class="user-controller" id="user-controller">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">User Editor</h1>
                            <button href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"  data-toggle="modal" data-target="#add-user"><i
                                    class="fas fa-plus fa-sm text-white-50"></i> Thêm User</button>
                        </div>
                        <section class="row">
                            <?php 
                                $users = getAllUsers();
                                for($i = 0; $i < count($users); $i++) {
                                    ...
                                    <!-- Card Header - Dropdown -->
                                    <div class='card-header py-3 d-flex flex-row align-items-center justify-content-between'>
                                        <h6 class='m-0 font-weight-bold text-primary'>ID: {$users[$i]->getID()}
                                        </h6>
                                        <div class='dropdown no-arrow'>
                                            <a class='dropdown-toggle' href='#' role='button' id='dropdownMenuLink'
                                                data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
                                        ...
                                        <div class='product-detail'>
                                            <form action='../Controller/AdminController.php' method='post' class='product-form'>
                                                ...
                                                <div class='input-box'>
                                                    ...
                                                    value='{$users[$i]->getFullName()}' disabled name='user-fullname'>
                                                </div>
                                                <div class='input-box'>
                                                    <input type='text' placeholder='Email' value='{$users[$i]->getEmail()}' disabled name='user-mail'>
                                                </div>
                                                <div class='input-box'>
